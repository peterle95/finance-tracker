...
**Net Worth snapshot**:
A dated record of account balances and total net worth.

**Net Worth history period**:
The number of most-recent available snapshots shown in the net worth history.

**Net Worth breakdown**:
A historical visualization of the asset balances making up net worth.
